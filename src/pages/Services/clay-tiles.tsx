                                          ...
                                          <div className="bg-white shadow-md rounded overflow-hidden text-center text-[#1a2940]">
                                                ...
                                                <div className="py-4 px-4">
                                                      ...
                                                      <div className="text-base">
                                                            <span className="text-[#F79D2B] mr-2">
                                                                  📞
                                                            </span>
                                                            <strong>
                                                                  (233) 415 9872
                        ...
                        <div className="w-full lg:w-2/3 bg-white p-6 sm:p-10 flex flex-col justify-start relative z-10 order-2 mt-[120px]">
                              ...
                              <div className="w-full lg:w-[74%] mt-[50px]">
                                    ...
                                    <p className="text-base text-[#555555] leading-relaxed mt-[40px]">
                                          ...
                                          aliquip exa aute irure dolor velit
                                          esse reprehenderit in voluptate cillum
                                          dolore nulla except sint ocaecat lorem
                                          ipsum dolor sit amet minim veniam quis
                                          nostrud ex duis aute irure dolor in
                                          reprehenderit in voluptate velit esse.
                                          <br />
                                          <br />
                                          In voluptate velit esse cillum dolore
                                          nulla par excep sint occaecat. Lorem
                              ...
                              <p className="w-full lg:w-[74%] mt-6 text-base leading-relaxed text-[#555555]">
                                    Eniam quis nostrud exercitation ullamco
                                    laboris nisi ut aliquip exa aute dolor in
                                    reprehenderit in voluptate velit esse cillum
                                    dolore nulla par excep sint occaecat. Lorem
                                    ipsum dolor sit amet, consectetur
                                    adipisicing elit eiusmod tempor incididunt
                              ...
                              <ul className="w-full lg:w-[74%] mt-4 space-y-2 text-base text-gray-700">
                                    <li className="flex items-start gap-3">
                                          <span className="text-[#F79D2B] font-semibold">
                                                ✔
                                          </span>
                              ...
                              <h2 className="w-full lg:w-[74%] mt-20 text-2xl font-bold text-[#1a2940]">
                                    Tiles installation and repair solutions
                              </h2>
                              ...
                              <div className="w-full lg:w-[74%] mt-[50px] flex flex-col md:flex-row gap-6 items-start">
                                    ...
                                    <p className="text-base text-[#555555] leading-relaxed md:w-1/2">
                                          ...
                                          ullamco laboris nisi ut aliquip exa
                                          aute dolor in reprehenderit in
                                          voluptate velit esse cillum dolore
                                          nulla par excep sint occaecat. Lorem
                                          ipsum dolor sit amet, cons ectetur
                                          adipisicing elit tempor.
                                          <br />
                                          <br />
                                          Incididunt ut labore et dolore. Magna
                                          aliqua. Ut enim ad minim veniam, quis
                                          nostrud exercitation ullam laboris
