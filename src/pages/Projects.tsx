...
const Projects = () => {
  return (
    <div className="font-montserrat">
      ...
      <div className="w-full px-4 py-16 bg-white mt-[-170px] md:mt-[-50px]">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-6">
          {[
            { src: "/project1.jpg", title: "Rolling Shutter" },
            { src: "/project2.jpg", title: "Entrance Automation" },
            { src: "/project3.jpg", title: "General Fabrication" },
          ].map((item, index) => (
            <div
              key={index}
              className="relative w-full md:w-1/3 group overflow-hidden"
            >
              <img
                src={item.src}
                alt={item.title}
